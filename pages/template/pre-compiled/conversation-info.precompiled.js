...
templates['conversation-info'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <form class=\"input-group w-100 mt-3\">\r\n                <span class=\"input-group-text bg-transparent text-white border-0\"><strong>Group name:</strong></span>\r\n                <input type=\"text\" class=\"form-control bg-transparent text-white border-0 noBoxShadow\"\r\n                    placeholder=\"Enter a group name...\" id=\"changeGroupNameInput\" value=\""
    ...
    + " \" "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isGroupOwner") : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(9, data, 0),"data":data,"loc":{"start":{"line":32,"column":100},"end":{"line":33,"column":57}}})) != null ? stack1 : "")
    + " />\r\n            </form>\r\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isGroupOwner") : depth0),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":43,"column":8},"end":{"line":56,"column":15}}})) != null ? stack1 : "")
    + "        <div class=\"modal-body d-flex w-100 d-flex flex-column overflow-y-auto gap-4 p-0 m-0\" id=\"showCaseMemberNewGroup\">\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"members") : depth0),{"name":"each","hash":{},"fn":container.program(20, data, 1, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":58,"column":12},"end":{"line":77,"column":21}}})) != null ? stack1 : "")
    + "        </div>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isGroupOwner") : depth0),{"name":"if","hash":{},"fn":container.program(24, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":79,"column":8},"end":{"line":85,"column":15}}})) != null ? stack1 : "");
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"isGroupOwner")||(depth0 && lookupProperty(depth0,"isGroupOwner"))||container.hooks.helperMissing).call(alias1,((stack1 = blockParams[1][0]) != null ? lookupProperty(stack1,"userID") : stack1),(depths[1] != null ? lookupProperty(depths[1],"ownerID") : depths[1]),{"name":"isGroupOwner","hash":{},"data":data,"blockParams":blockParams,"loc":{"start":{"line":70,"column":22},"end":{"line":70,"column":59}}}),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.program(22, data, 0, blockParams, depths),"data":data,"blockParams":blockParams,"loc":{"start":{"line":70,"column":16},"end":{"line":74,"column":23}}})) != null ? stack1 : "");
},"22":function(container,depth0,helpers,partials,data) {
    return "                <button class=\"btn btn-warning h-75 w-50 me-4\">Give 👑</button>\r\n                <button class=\"btn btn-danger h-75 w-25 me-4\">Remove</button>\r\n";
},"24":function(container,depth0,helpers,partials,data) {
    return "        <div class=\"modal-footer w-100 d-flex justify-content-center align-items-center\">\r\n            <button class=\"btn btn-primary w-100\" id=\"updateGroupButton\">\r\n                Update group\r\n            </button>\r\n        </div>\r\n";
  ...
  return "<div class=\"modal-dialog modal-dialog-centered\">\r\n    <div class=\"modal-content bg-black text-white glassmorph\">\r\n        <div class=\"modal-header d-flex flex-column p-0 border-0 position-relative\">\r\n            <h5 class=\"modal-title pt-3\">"
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isDirect") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":20,"column":55},"end":{"line":20,"column":86}}})) != null ? stack1 : "")
    + " "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isGroupOwner") : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.program(9, data, 0, blockParams, depths),"data":data,"blockParams":blockParams,"loc":{"start":{"line":20,"column":87},"end":{"line":21,"column":61}}})) != null ? stack1 : "")
    ...
    + "            <hr class=\"w-100 border-white border-2\" />\r\n        </div>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isDirect") : depth0),{"name":"if","hash":{},"fn":container.program(15, data, 0, blockParams, depths),"inverse":container.program(17, data, 0, blockParams, depths),"data":data,"blockParams":blockParams,"loc":{"start":{"line":38,"column":8},"end":{"line":86,"column":15}}})) != null ? stack1 : "")
    + "    </div>\r\n</div>";

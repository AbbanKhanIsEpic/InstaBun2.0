...
templates['post-explore'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div\r\n    class=\"card bg-black post d-flex flex-row mb-4 w-100 justify-content-center mt-4\"\r\n    id="
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"hasBookmarked") : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.program(12, data, 0),"data":data,"loc":{"start":{"line":117,"column":8},"end":{"line":143,"column":15}}})) != null ? stack1 : "")
    + "      </div>\r\n    </div>\r\n    <hr />\r\n  </div>\r\n";
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"post") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":148,"column":9}}})) != null ? stack1 : "");
},"useData":true});
})();
...
templates['search-user'] = template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div\r\n    class=\"user d-flex flex-row justify-content-between align-items-center w-100 pt-2 pb-2\"\r\n  >\r\n    <div class=\"d-flex flex-row ms-4\">\r\n      <img\r\n        src=\""
    ...
    + "\r\n        </div>\r\n      </div>\r\n    </div>\r\n"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? lookupProperty(stack1,"isFollowing") : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams,"loc":{"start":{"line":22,"column":4},"end":{"line":32,"column":11}}})) != null ? stack1 : "")
    + "  </div>\r\n";
  ...
  return "      <button\r\n        class=\"btn bg-dark-subtle h-75 w-25 me-4\"\r\n        id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? lookupProperty(stack1,"userID") : stack1), depth0))
    + "\"\r\n      >Unfollow</button>\r\n";

...
templates['user-list'] = template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div\r\n    class=\"user d-flex flex-row justify-content-between align-items-center w-100 pt-2 pb-2\"\r\n  >\r\n    <div class=\"d-flex flex-row ms-4\">\r\n      <img\r\n        src=\""
    ...
    + "\"\r\n        height=\"50\"\r\n        width=\"50\"\r\n        alt=\"\"\r\n        class=\"rounded-circle profileIcon\"\r\n        onclick=\"window.location.href='http://127.0.0.1:5500/pages/profile.html?userID="
    ...
    + "\r\n        </div>\r\n      </div>\r\n    </div>\r\n"
    + ((stack1 = (lookupProperty(helpers,"ifNotCurrentUser")||(depth0 && lookupProperty(depth0,"ifNotCurrentUser"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? lookupProperty(stack1,"userID") : stack1),{"name":"ifNotCurrentUser","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams,"loc":{"start":{"line":23,"column":4},"end":{"line":35,"column":25}}})) != null ? stack1 : "")
    + "  </div>\r\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? lookupProperty(stack1,"isFollowing") : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams,"loc":{"start":{"line":24,"column":6},"end":{"line":34,"column":13}}})) != null ? stack1 : "");
